...
- [CRYPTO_5_15_30_FACTOR_SCHEMA_PROPOSAL.md](CRYPTO_5_15_30_FACTOR_SCHEMA_PROPOSAL.md)
  5/15/30 统一窗口因子提案，解释每个候选因子的含义、尺度和现货/永续适用范围。
...
- [CRYPTO_5_15_30_FACTOR_SCHEMA_PROPOSAL.md](CRYPTO_5_15_30_FACTOR_SCHEMA_PROPOSAL.md)
  下一版 crypto 技术因子窗口和合约因子的候选 schema。
...
- [CRYPTO_5_15_30_FACTOR_SCHEMA_PROPOSAL.md](CRYPTO_5_15_30_FACTOR_SCHEMA_PROPOSAL.md)
  决定是否把当前 32 维因子改成 5/15/30 统一窗口前应先读。
